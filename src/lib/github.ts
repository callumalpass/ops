import type { GitHubItem, RemoteKind } from "./types.js";
...
export async function fetchItem(kind: RemoteKind, number: number, cwd: string, repo?: string): Promise<GitHubItem> {
